...
class Worker(mp.Process):
    ...
    def _cfr(self, t, i):
        ...
        self._setup_new_game()
        use_pruning: bool = np.random.uniform() < 0.95 #有概率的
    ...
    def _discount(self, t): #折扣系数
        ...
        ) #折扣因子 对先前的遗憾和策略进行折扣操作
        # 模型逐渐接近 最优解了，那么早期步骤遗憾 和 策略 可能对当前的策略学习不会有太大的影响了 从而让模型更多的关注最近的经验和策略
    ...
    def _setup_new_game(self):  #设置新游戏
